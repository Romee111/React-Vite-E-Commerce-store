...
import  '../styling/termconditions.css';
  ...
  return (
    <div className="terms">
      <h1 style={{textAlign:"center",marginTop:"2%"}}>Terms and Conditions</h1>
        ...
        <p>    Welcome to Restorex, your premier destination for all things e-commerce. Here at Restorex, also referred to as "we", "us", or "Restorex", we are dedicated to providing a seamless online marketplace experience. These terms and conditions govern your access to and use of Restorex, including its sub-domains, mobile app, services, and tools (collectively, the "Platform").

             By accessing or using Restorex, you agree to be bound by these terms and conditions (the "User Agreement"). If you do not agree with any part of these terms, please refrain from accessing or using Restorex. Your use of Restorex signifies your acceptance of this User Agreement, which becomes effective upon your first use of the Platform.

                Restorex is owned and operated by Sohaib Romee, committed to delivering a secure and user-friendly e-commerce platform. We reserve the right to modify, amend, add, or remove portions of these terms and conditions at any time without prior notice. It is your responsibility to review these terms regularly for updates. Continued use of Restorex following any changes constitutes your acceptance of those changes.

              </p>
    
        <h2>2. Conditions of Use</h2>
        <p>
          <strong>A. Your Account</strong><br />
          To access certain services on Restorex, you may need to create an account and provide personal information. We reserve the right to invalidate usernames or passwords at our discretion without prior notice, and we are not liable for any resulting losses.

          You are responsible for maintaining the confidentiality of your account details and ensuring their security. Notify us immediately if you suspect unauthorized access or use of your account. You agree that any activity on your account is your responsibility, and we may act upon it as if authorized by you. You agree to indemnify us against any losses arising from such use.

            Ensure your account information is accurate and update it promptly. We may refuse access, terminate accounts, or edit content without notice. We may also request updates to your personal data or invalidate accounts without prior notice, and we are not liable for any resulting losses.
          </p>

         <h2>3. Platform for Communication</h2> 
         <p>
              ...
              <h2>6. Communicating with Us</h2>
                   ...
                   Restorex's Buyer-Seller Interaction Policy outlines the standards of behavior sellers must adhere to when interacting with customers, including through the Question & Answer section, Instant Messenger, and Product Review platform. Restorex monitors all buyer-seller communications and reserves the right to take action in case of violations.
                    ...
                    <p>Reselling Restorex products for business purposes is strictly prohibited. Unauthorized reselling may result in legal action being taken.</p>
                     <h2>Taxes</h2>
                        <p>
                        ince Restorex operates as a free-charge platform, you are not responsible for payment of fees, costs, or charges associated with the purchase of products from the platform. There are no applicable taxes as per prevailing law due to the nature of our free-charge model.
                           Reselling Restorex products for business purposes is strictly prohibited. Unauthorized reselling may result in legal action being taken.
                        </p>
